...
#            command+='git rm .\\push.bat --cache\r\n'
            ...
            for file_index in current_dir_file_list :
                if 'packet.pck'==file_index[1] :
                    continue
                elif 'blue_fariy.py'==file_index[1] :
                    continue
